...
* Copy the [`espresso.json`] file into the `schemes` section of the settings.
* In the Windows Terminal Settings UI, go to your linux box settings > Aappearance and Choose `Espresso` as the theme.
